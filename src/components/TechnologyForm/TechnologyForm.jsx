    ...
    <form onSubmit={handleSubmit} className="technology-form" noValidate>
      ...
      <div className="form-group">
        ...
        <textarea
          ...
          aria-describedby={
            submitted && errors.description ? "description-error" : undefined
          }
          required
        />
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={handleChange}
          className={submitted && errors.deadline ? "error" : ""}
          aria-describedby={
            submitted && errors.deadline ? "deadline-error" : undefined
          }
        />
        {submitted && errors.deadline && (
        ...
        {formData.resources.map((resource, index) => (
          <div key={index} className="resource-field">
            <input
              ...
              className={
                submitted && errors[`resource_${index}`] ? "error" : ""
              }
              aria-describedby={
                submitted && errors[`resource_${index}`]
